...
export function NameLogo({ name }: { name: string | null }) {
  ...
  return (
    <Link
      ...
      className="namelogo font-[var(--font-sofia-sans-extra-condensed)] text-[1.7rem] font-black uppercase italic tracking-[0.04em] text-[#111111] transition-colors hover:text-[#c4621a] md:text-[1.85rem]"
      ref={logoRef}
    >
      {logoName}
    </Link>
